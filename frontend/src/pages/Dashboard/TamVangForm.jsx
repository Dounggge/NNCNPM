...
export default function TamVangForm() {
  ...
  return (
    <>
      <PageMeta title="Đăng ký tạm vắng" />
      <PageBreadcrumb
        pageTitle="Đăng ký tạm vắng"
        items={[
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Khai báo thông tin vắng mặt tạm thời
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={3}
              placeholder="VD: TP. Hồ Chí Minh, Hà Nội, Đà Nẵng... (ghi rõ địa chỉ cụ thể)"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white placeholder-gray-400 transition-all"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white transition-all"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={3}
              placeholder="VD: Đi công tác, du lịch, thăm thân nhân, điều trị bệnh..."
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white placeholder-gray-400 transition-all"
            />
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-yellow-800 dark:text-yellow-400">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Đơn tạm vắng chỉ là <strong>thông tin tham khảo</strong></li>
                  <li>Tổ trưởng sẽ xem và <strong>tự thêm vào danh sách tạm vắng</strong></li>
                  <li>Thời gian tạm vắng phải từ 1 ngày trở lên</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-rose-500 to-red-500 text-white rounded-lg hover:from-rose-600 hover:to-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg font-medium flex items-center gap-2"
            >
              {loading ? (
                <>
